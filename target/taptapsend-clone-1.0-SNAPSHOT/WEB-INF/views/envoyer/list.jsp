                ...
                <div class="max-w-6xl mx-auto">
                    <section class="card">
                        <div class="flex flex-wrap items-end justify-between gap-4 mb-8">
                            ...
                            <div class="flex gap-3 items-center flex-wrap">
                                <form action="${pageContext.request.contextPath}/envois/search" method="get"
                                    ...
                                    <c:if test="${not empty dateRecherche}">
                                        <a href="${pageContext.request.contextPath}/envois/list" class="btn btn-danger"
                                            style="padding: 0.7rem;">✕</a>
                                    </c:if>
                                </form>
                            ...
                            <form action="${pageContext.request.contextPath}/releve-pdf" method="get"
                                class="flex gap-2 items-center flex-wrap">
                                <input type="text" name="numtel" placeholder="Numéro client" class="input"
                                    style="border-radius: 999px; padding: 0.5rem 1rem;">
                                <input type="month" name="mois" class="input"
                                    style="border-radius: 999px; padding: 0.5rem 1rem;">
                        ...
                        <div class="table-wrap scroll-x">
                                ...
                                <tbody>
                                    <c:forEach var="e" items="${envoyers}">
                                        <tr>
                                            ...
                                            <td>
                                                <div style="font-size: 1.1rem; font-weight: 800; color: #0B0B0B;">
                                                    ${e.montant} €</div>
                                            </td>
                                            <td>
                            ...
                            <div class="card p-4 bg-white rounded-lg shadow-sm mt-6">
                                <h3 class="font-bold text-lg mb-2">Recette totale de l'opérateur</h3>
                                <p>Total des frais perçus :
                                    <span id="display-recette" hx-get="${pageContext.request.contextPath}/recette"
                                        hx-trigger="load" hx-swap="innerHTML">
                                        Chargement...
                                    </span>
                                </p>

                                <button class="btn btn-ghost mt-2" hx-get="${pageContext.request.contextPath}/recette"
                                    hx-target="#display-recette" hx-swap="innerHTML">
                                    🔄 Actualiser
                                </button>
                            </div>
